...
flowchart LR
    Feed(Feed<br/>acquisition) --> Decode(Video<br/>decoding)
    Decode --> Motion(Motion<br/>detection)
    Motion --> Object(Object<br/>detection)
    Feed --> Recording(Recording<br/>and<br/>visualization)
    Motion --> Recording
    Object --> Recording
```
